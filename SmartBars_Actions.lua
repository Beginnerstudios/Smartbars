...
function Actions:Create(action,isEnabled,isExisting,key)
  ...
  local cA = Actions:GetCurrent()
    ...
    cA[actionID]= {action[1],action[2],Templates:PanelActionWidget(action,ActionBars:GetActionBar(trackedFrame).configWidgets[3],true),action[4],curretSpec,trackedFrame,isBoosted,showOnlyWhenBoosted,actionType,isPVP}
